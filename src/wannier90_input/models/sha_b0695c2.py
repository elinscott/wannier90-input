...
class Wannier90Input(Wannier90InputTemplate):
    ...
    one_dim_axis: Literal["x", "y", "z"] = Field(None, description="Extended direction for a one-dimensional system")
    use_ss_functional: bool = Field(False, description="Use Stengel-Spaldin functional in place of the Marzari-Vanderbilt functional")
