...
class Wannier90Input(BaseModel):
    ...
    dis_spheres: float = Field(..., description="List of centres and radii, for disentanglement only in spheres")
    ...
    slwf_centres: float = Field(..., description="The centres to which the objective WFs are to be constrained")
    ...
    translation_centre_frac: float = Field(..., description="Centre of the unit cell to which final WF are translated")
